% ##############################################################################
% ##  ber_dpsk_koh_awgn_save.m : Speichern und Laden von                      ##
% ##                             Simulationsergebnissen der Routine           ##
% ##                             ber_dpsk_koh_awgn.m                          ##
% ##############################################################################
%
% function [meanber, ber, ser, biterror, bitcount, symerror, symcount] = ...
%  ber_dpsk_koh_awgn_save(EbN0db,M,map,maxbiterror,maxbitcount)
% ------------------------------------------------------------------------------
% EINGABE:
...
function [meanber, ber, ser, biterror, bitcount, symerror, symcount] = ...
  ber_dpsk_koh_awgn_save (EbN0db,M,map,maxbiterror)
